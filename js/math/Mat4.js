...
Object.assign( Mat4.prototype, {
	...
	clone: function () {
		...
		return new Mat4().fromArray( this.es );
	...
	extractRotation: function () {
		...
		return function extractRotation( m ) {
			...
			var scaleX = 1 / v1.setFromMatColumn( m, 0 ).length();
			var scaleY = 1 / v1.setFromMatColumn( m, 1 ).length();
			var scaleZ = 1 / v1.setFromMatColumn( m, 2 ).length();
	...
	decompose: function () {
		...
		return function decompose( position, quaternion, scale ) {
			...
			quaternion.setFromRotationMat( matrix );
