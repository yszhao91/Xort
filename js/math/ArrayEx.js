...
if (Array.prototype.removeLast === undefined)
  Array.prototype.removeLast = function() {
     return  this.pop();
  };

if (Array.prototype.removeFirst === undefined)
  ...
  Array.prototype.unique = function(method) {
    for (var s = 0; s < this.length; s++) {
      ...
      for (var i = s + 1; i < this.length; ) {
        if (method(refObj, this[i])) this.removeAt(i);
        else i++;
      }
    }
  };
...
if (Array.prototype.dcfind === undefined)
  Array.prototype.dcfind = function(refobj, method) {
    for (var s = 0; s < this.length; s++) {
      if (method(refobj, this[s])) return this[s];
    }
  };
