...
Object.assign( Quat.prototype, {
	...
	setFromUnitVecs: function () {
		...
		return function setFromUnitVecs( vFrom, vTo ) {
	...
	mul: function ( q, p ) {
		...
		if ( p !== undefined ) {
			...
			console.warn( 'Quat: .mul() now only accepts one argument. Use .mulQuats( a, b ) instead.' );
			return this.mulQuats( q, p );

		}

		return this.mulQuats( this, q );

	},

	premul: function ( q ) {

		return this.mulQuats( q, this );

	},

	mulQuats: function ( a, b ) {
