...
export const ZERO = 0;
export const
export const activeTexture = "activeTexture";
export const attachShader = "attachShader";
export const bindAttribLocation = "bindAttribLocation";
export const bindBuffer = "bindBuffer";
export const bindFramebuffer = "bindFramebuffer";
export const bindRenderbuffer = "bindRenderbuffer";
export const bindTexture = "bindTexture";
export const blendColor = "blendColor";
export const blendEquation = "blendEquation";
export const blendEquationSeparate = "blendEquationSeparate";
export const blendFunc = "blendFunc";
export const blendFuncSeparate = "blendFuncSeparate";
export const bufferData = "bufferData";
export const bufferSubData = "bufferSubData";
export const checkFramebufferStatus = "checkFramebufferStatus";
export const clear = "clear";
export const clearColor = "clearColor";
export const clearDepth = "clearDepth";
export const clearStencil = "clearStencil";
export const colorMask = "colorMask";
export const compileShader = "compileShader";
export const compressedTexImage2D = "compressedTexImage2D";
export const compressedTexSubImage2D = "compressedTexSubImage2D";
export const copyTexImage2D = "copyTexImage2D";
export const copyTexSubImage2D = "copyTexSubImage2D";
export const createBuffer = "createBuffer";
export const createFramebuffer = "createFramebuffer";
export const createProgram = "createProgram";
export const createRenderbuffer = "createRenderbuffer";
export const createShader = "createShader";
export const createTexture = "createTexture";
export const cullFace = "cullFace";
export const deleteBuffer = "deleteBuffer";
export const deleteFramebuffer = "deleteFramebuffer";
export const deleteProgram = "deleteProgram";
export const deleteRenderbuffer = "deleteRenderbuffer";
export const deleteShader = "deleteShader";
export const deleteTexture = "deleteTexture";
export const depthFunc = "depthFunc";
export const depthMask = "depthMask";
export const depthRange = "depthRange";
export const detachShader = "detachShader";
export const disable = "disable";
export const disableVertexAttribArray = "disableVertexAttribArray";
export const drawArrays = "drawArrays";
export const drawElements = "drawElements";
export const enable = "enable";
export const enableVertexAttribArray = "enableVertexAttribArray";
export const finish = "finish";
export const flush = "flush";
export const framebufferRenderbuffer = "framebufferRenderbuffer";
export const framebufferTexture2D = "framebufferTexture2D";
export const frontFace = "frontFace";
export const generateMipmap = "generateMipmap";
export const getActiveAttrib = "getActiveAttrib";
export const getActiveUniform = "getActiveUniform";
export const getAttachedShaders = "getAttachedShaders";
export const getAttribLocation = "getAttribLocation";
export const getBufferParameter = "getBufferParameter";
export const getContextAttributes = "getContextAttributes";
export const getError = "getError";
export const getExtension = "getExtension";
export const getFramebufferAttachmentParameter = "getFramebufferAttachmentParameter";
export const getParameter = "getParameter";
export const getProgramParameter = "getProgramParameter";
export const getProgramInfoLog = "getProgramInfoLog";
export const getRenderbufferParameter = "getRenderbufferParameter";
export const getShaderParameter = "getShaderParameter";
export const getShaderInfoLog = "getShaderInfoLog";
export const getShaderPrecisionFormat = "getShaderPrecisionFormat";
export const getShaderSource = "getShaderSource";
export const getSupportedExtensions = "getSupportedExtensions";
export const getTexParameter = "getTexParameter";
export const getUniform = "getUniform";
export const getUniformLocation = "getUniformLocation";
export const getVertexAttrib = "getVertexAttrib";
export const getVertexAttribOffset = "getVertexAttribOffset";
export const hint = "hint";
export const isBuffer = "isBuffer";
export const isContextLost = "isContextLost";
export const isEnabled = "isEnabled";
export const isFramebuffer = "isFramebuffer";
export const isProgram = "isProgram";
export const isRenderbuffer = "isRenderbuffer";
export const isShader = "isShader";
export const isTexture = "isTexture";
export const lineWidth = "lineWidth";
export const linkProgram = "linkProgram";
export const pixelStorei = "pixelStorei";
export const polygonOffset = "polygonOffset";
export const readPixels = "readPixels";
export const renderbufferStorage = "renderbufferStorage";
export const sampleCoverage = "sampleCoverage";
export const scissor = "scissor";
export const shaderSource = "shaderSource";
export const stencilFunc = "stencilFunc";
export const stencilFuncSeparate = "stencilFuncSeparate";
export const stencilMask = "stencilMask";
export const stencilMaskSeparate = "stencilMaskSeparate";
export const stencilOp = "stencilOp";
export const stencilOpSeparate = "stencilOpSeparate";
export const texParameterf = "texParameterf";
export const texParameteri = "texParameteri";
export const texImage2D = "texImage2D";
export const texSubImage2D = "texSubImage2D";
export const uniform1f = "uniform1f";
export const uniform1fv = "uniform1fv";
export const uniform1i = "uniform1i";
export const uniform1iv = "uniform1iv";
export const uniform2f = "uniform2f";
export const uniform2fv = "uniform2fv";
export const uniform2i = "uniform2i";
export const uniform2iv = "uniform2iv";
export const uniform3f = "uniform3f";
export const uniform3fv = "uniform3fv";
export const uniform3i = "uniform3i";
export const uniform3iv = "uniform3iv";
export const uniform4f = "uniform4f";
export const uniform4fv = "uniform4fv";
export const uniform4i = "uniform4i";
export const uniform4iv = "uniform4iv";
export const uniformMatrix2fv = "uniformMatrix2fv";
export const uniformMatrix3fv = "uniformMatrix3fv";
export const uniformMatrix4fv = "uniformMatrix4fv";
export const useProgram = "useProgram";
export const validateProgram = "validateProgram";
export const vertexAttrib1f = "vertexAttrib1f";
export const vertexAttrib1fv = "vertexAttrib1fv";
export const vertexAttrib2f = "vertexAttrib2f";
export const vertexAttrib2fv = "vertexAttrib2fv";
export const vertexAttrib3f = "vertexAttrib3f";
export const vertexAttrib3fv = "vertexAttrib3fv";
export const vertexAttrib4f = "vertexAttrib4f";
export const vertexAttrib4fv = "vertexAttrib4fv";
export const vertexAttribPointer = "vertexAttribPointer";
